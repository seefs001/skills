...
- **`/telegram-message`**: send any user-requested content to Seefs through Telegram. The explicit request is the only trigger; the message does not need to be a blocker or a hard problem.
