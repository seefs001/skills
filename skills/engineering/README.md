...
- **[implement](./implement/SKILL.md)** — Build the work described by a spec or set of tickets, driving `/tdd` at pre-agreed seams and committing to the current branch.
...
- **[state-modeling](./state-modeling/SKILL.md)** — Clarify state machines and lifecycle behavior before implementation: states, events, legal/illegal transitions, invariants, terminal states, side effects, and replay/race behavior.
