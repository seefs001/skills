...
This is Seefs' fork of `mattpocock/skills`.
Fork-specific changes are tracked in [FORK-CHANGELOG.md](./FORK-CHANGELOG.md).
...
- **[implement](./skills/engineering/implement/SKILL.md)** — Build the work described by a spec or set of tickets, driving `/tdd` at pre-agreed seams and committing to the current branch.
...
- **[state-modeling](./skills/engineering/state-modeling/SKILL.md)** — Clarify state machines and lifecycle behavior before implementation: states, events, legal/illegal transitions, invariants, terminal states, side effects, and replay/race behavior.
